...
function generateSchema(generateParameters) {
    ...
    if (generateParameters[ux_specification_types_1.FioriElementsVersion.v2]) {
        ...
        if (v4Params[ux_specification_types_1.SchemaType.ListReport]) {
            ...
            schema = (0, generate_2.generateListReportInterfaceV4)(ux_specification_types_1.TemplateType.ListReportObjectPageV4, genericSchema, entitySet, annotations, logger, manifest);
        }
            ...
            schema = (0, generate_2.generateObjectPageInterfaceV4)(genericSchema, entitySet, annotations, manifest, logger, fragments);
        }
            ...
            schema = (0, generate_2.generateListReportInterfaceV4)(ux_specification_types_1.TemplateType.AnalyticalListPageV4, genericSchema, entitySet, annotations, logger, manifest);
        }
