...
function addFlexChangeForSection(appSchema, schemaSection, property, sectionType) {
    ...
    (0, common_2.addPatternForBindingChangeOfEnumOP)(appSchema, schemaSection, property);
...
function addHeaderActionCallBackV2(entityType, appSchema, actionAnnotation, headerActions, oDataServiceAVT) {
    return (item, index) => {
        if (!item['Determining'] && item.$Type === "com.sap.vocabularies.UI.v1.DataFieldForAction" /* UIAnnotationTypes.DataFieldForAction */) {
            const { actionName, actionId, namespace } = (0, common_2.getActionNameAndId)(item, oDataServiceAVT);
            ...
            const actionDefinitionKey = `HeaderAction<${(0, common_2.prepareRef)(actionId)}>`;
...
function addTableDefinition(tableType, facetId, facet, appSchema) {
    const schemaId = (0, common_2.prepareRef)(`${tableType}<${facetId}>`);
    ...
    (0, common_2.addEnumForSingleTabVariant)(facet.entityType, appSchema, `QuickVariant<${facetId}>`);
}
/**
...
function handleLineItem(generateParameters, facetKey, appSchema, facet, facets, sectionType) {
    ...
    appSchema.definitions[schemaIdForOpSection] = (0, common_2.createDefaultSection)(appSchema, facet, facetKey);
    ...
    (0, common_2.addSectionTitleAndDescription)(facet, appSchemaSection, facetKey);
    ...
    // Find target entity
    const targetEntitySet = (0, common_2.determineEntitySetOfFacet)(facet, generateParameters.serviceAVT);
    if (targetEntitySet) {
...
function handleSubSection(appSchema, definitionKey, facet, facetId, sectionType) {
    appSchema.definitions[definitionKey] = (0, common_2.createDefaultSection)(appSchema, facet, facetId);
...
function handleSectionChart(appSchema, definitionKey, facet, facetKey, sectionType) {
    appSchema.definitions[definitionKey] = (0, common_2.createDefaultSection)(appSchema, facet, facetKey);
    const appSchemaSection = appSchema.definitions[definitionKey];
...
function addSection(generateParameters, facets, facetKey, sections, appSchema, isSubSection = false) {
    ...
    switch (sectionType) {
        ...
        case types_1.SectionTypeV2.SubSectionTable: {
            ...
            (0, common_2.addFieldsType)(appSchema, facet.entityType, floorplanSuffix);
            break;
        }
        case types_1.SectionTypeV2.SectionChart:
        case types_1.SectionTypeV2.SubSectionChart: {
        ...
        case types_1.SectionTypeV2.SubSectionForm: {
            ...
            (0, common_2.handleForm)(ux_specification_types_1.SectionType.Section, facet, appSchemaSection, appSchema, ux_specification_types_1.FioriElementsVersion.v2, facetKey);
            break;
        }
        case types_1.SectionTypeV2.SectionAddress:
        case types_1.SectionTypeV2.SectionContact: {
            (0, common_2.handleAddressContact)(facet, facetKey, sections, appSchema, ux_specification_types_1.SectionType.Section, undefined, 'V2');
            break;
        }
        case types_1.SectionTypeV2.SubSectionAddress:
        case types_1.SectionTypeV2.SubSectionContact: {
            (0, common_2.handleAddressContact)(facet, facetKey, sections, appSchema, ux_specification_types_1.SectionType.Section, ux_specification_types_1.SectionType.SubSection, 'V2');
            break;
        }
        default: {
            // Other facets -> only default properties of ObjectPageSection
            sections.properties[facetKey] = (0, common_2.createDefaultSection)(appSchema, facet, facetKey);
        }
    }
}
/**
...
function addSections(generateParameters, appSchema, pages) {
    ...
    if (generateParameters.entitySet?.entityType) {
        sections[ux_specification_types_1.SchemaTag.annotationPath] = `/${generateParameters.entitySet.entityType.fullyQualifiedName}/@${"com.sap.vocabularies.UI.v1.Facets" /* UIAnnotationTerms.Facets */}`;
    }
    if (!pages) {
        return;
    }
    // Get facet annotations
    const facets = (0, common_2.getObjectPageFacets)(generateParameters.entitySet?.entityType, generateParameters.serviceAVT, ux_specification_types_1.FioriElementsVersion.v2, generateParameters.logger);
...
function addHeader(appSchema, entityType, oDataServiceAVT) {
    (0, common_2.addCommonHeaderSchema)(appSchema, entityType);
    //Add header actions
    (0, common_2.addHeaderActions)(appSchema, entityType, oDataServiceAVT, addHeaderActionCallBackV2, true);
}
/**
...
function addRelatedFacetKeysType(schema, entityType, oDataServiceAVT, logger) {
    ...
    const facetSections = (0, common_2.getObjectPageFacetSection)(entityType, oDataServiceAVT, logger, undefined, true);
    if (facetSections) {
        (0, common_2.addDefinitionForRelatedFacetKeys)(schema, ['ObjectPageCustomSectionFragment', 'ObjectPageCustomSectionView'], facetSections, ['ID', 'key']);
    }
}
/**
...
function generateObjectPageSchemaV2(generateParameters, genericSchema) {
    ...
    (0, common_2.addFooterActions)(appSchema, generateParameters, ux_specification_types_1.FioriElementsVersion.v2, pages);
