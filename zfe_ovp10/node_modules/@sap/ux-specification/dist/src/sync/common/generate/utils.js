...
exports.addKeyToDefinition = exports.getActionKey = exports.addFieldsType = exports.handleAddressContact = exports.getFacetAnnotationPath = exports.addDefinitionRef = exports.getFacetDefinitionLink = exports.addDataTypeToDefinition = exports.determineDataType = exports.determineDataTypeOfTarget = exports.getDataTypeFromAnnotation = exports.DataType = exports.addCommonLineItemDefinitions = exports.parseSchemaDefinition = exports.getFacetKeyInSchema = exports.addDefinitionForRelatedFacetKeys = exports.addEnumForVariantEntitySet = exports.addEnumForMultiTabVariant = exports.addEnumForSingleTabVariant = exports.addEnumForValidAnnotations = exports.addEnumToSchema = void 0;
const __1 = require("..");
 ...
 */
function addCommonLineItemDefinitions(appSchema, lineItemAnnotation, entityType, lineItemId, customColumnDefinitionName) {
    let lineItemPath;
    ...
    if (lineItemId === ux_specification_types_1.DefinitionName.LineItems ||
        ...
        additionalPropertiesRef = `${__1.DEFINITION_LINK_PREFIX}${customColumnDefinitionName}`;
    }
    else {
        additionalPropertiesRef = `${__1.DEFINITION_LINK_PREFIX}${customColumnDefinitionName}<${lineItemId}>`;
    ...
    if (lineItemAnnotation) {
        ...
        if (lineItemPath) {
            appSchema.definitions[lineItemId][ux_specification_types_1.SchemaTag.annotationPath] = appSchema.definitions[schemaIdForToolBar][ux_specification_types_1.SchemaTag.annotationPath] = lineItemPath;
            if (footerActions) {
