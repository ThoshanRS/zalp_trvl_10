...
async function getGenericSchemas(templateType, fioriElementsVersion) {
    ...
    switch (templateType) {
        ...
        case ux_specification_types_1.TemplateType.FreestylePageV4:
            schemaTypes.push(ux_specification_types_1.SchemaType.ListReport, ux_specification_types_1.SchemaType.ObjectPage, ux_specification_types_1.SchemaType.FreestylePage);
            break;
    ...
    for (const schemaType of schemaTypes) {
        const schemaFile = (0, utils_1.getSchemaFilePath)(schemaType);
...
function getAnnotationsForUi(oDataServiceAVT) {
    ...
    const alias = (0, utils_1.findAlias)(ux_specification_types_1.UIVOCABULARY, oDataServiceAVT);
...
function generateObjectPageSchemasV2(generateParameters, genericSchemas, appSchemas) {
    ...
    for (const page in allPages) {
        ...
        const schemaFile = (0, utils_1.getSchemaFilePath)(ux_specification_types_1.SchemaType.ObjectPage, entitySet?.name || entitySetName);
        const genericSchemaFile = (0, utils_1.getSchemaFilePath)(ux_specification_types_1.SchemaType.ObjectPage);
...
function generateListReportSchemasV4(generateParameters, genericSchemas, appSchemas) {
    ...
    for (const pageId in pages) {
        ...
        const entitySet = getEntitySetByEntitySetName(entitySetName, generateParameters.serviceAVT);
        const schemaFile = (0, utils_1.getSchemaFilePath)(ux_specification_types_1.SchemaType.ListReport, entitySet?.name || entitySetName);
        const genericSchemaFile = (0, utils_1.getSchemaFilePath)(ux_specification_types_1.SchemaType.ListReport);
        ...
        if (generateParameters.templateType === ux_specification_types_1.TemplateType.FreestylePageV4) {
            generateParameters.templateType = (0, utils_1.determineV4PageTemplateType)(pages[pageId]);
        }
        appSchemas[schemaFile.filename] = (0, generate_2.generateListReportSchemaV4)(generateParameters, genericSchemas[genericSchemaFile.filename], entitySet, pages[pageId].name);
    }
}
/**
...
function generateAppSchemaV2LR(generateParameters, appSchemas, genericSchemas) {
    ...
    for (const page in allPages) {
        ...
        const schemaFile = (0, utils_1.getSchemaFilePath)(ux_specification_types_1.SchemaType.ListReport, generateParameters.entitySet?.name || entitySetName);
        const genericSchemaFile = (0, utils_1.getSchemaFilePath)(ux_specification_types_1.SchemaType.ListReport);
...
function generateObjectPageSchemasV4(generateParameters, genericSchemas, appSchemas) {
    ...
    for (const page in pages) {
        ...
        const schemaFile = (0, utils_1.getSchemaFilePath)(ux_specification_types_1.SchemaType.ObjectPage, entitySet?.name || entitySetName);
        const genericSchemaFile = (0, utils_1.getSchemaFilePath)(ux_specification_types_1.SchemaType.ObjectPage);
        appSchemas[schemaFile.filename] = (0, generate_2.generateObjectPageSchemaV4)(generateParameters, genericSchemas[genericSchemaFile.filename], entitySet);
    }
}
/**
...
function generateAppSchemasV2(generateParameters, genericSchemas, uiEntityTypes, templateType) {
    ...
    if (templateType === ux_specification_types_1.TemplateType.ListReportObjectPageV2 && uiEntityTypes) {
        ...
        for (const page in allPages) {
            const entitySetName = allPages[page].entitySet;
            generateParameters.entitySet = getEntitySetByEntitySetName(entitySetName, generateParameters.serviceAVT);
            const schemaFile = (0, utils_1.getSchemaFilePath)(ux_specification_types_1.SchemaType.AnalyticalListPage, generateParameters.entitySet?.name || entitySetName);
            const genericSchemaFile = (0, utils_1.getSchemaFilePath)(ux_specification_types_1.SchemaType.AnalyticalListPage);
        ...
        /*--- Overview Page ----*/
        const schemaFile = (0, utils_1.getSchemaFilePath)(ux_specification_types_1.SchemaType.OverviewPage);
        const genericSchemaFile = (0, utils_1.getSchemaFilePath)(ux_specification_types_1.SchemaType.OverviewPage);
...
async function importProjectSchema(importProjectParameters) {
    ...
    const fioriElementsVersion = (0, utils_1.getVersionFromManifest)(manifest);
    const oDataServiceAVT = (0, utils_1.parseAndMergeAndConvert)(annotations, logger);
    const uiEntityTypes = getAnnotationsForUi(oDataServiceAVT);
    const templateType = (0, utils_1.getTemplateTypeFromManifest)(manifest, fioriElementsVersion, logger);
