...
var require_types = __commonJS({
  "../../node_modules/@sap-ux/logger/dist/types.js"(exports) {
    "use strict";
...
var require_transport = __commonJS({
  "../../node_modules/@sap-ux/logger/dist/transports/transport.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    exports.UI5ToolingTransport = UI5ToolingTransport2;
...
var require_transports = __commonJS({
  "../../node_modules/@sap-ux/logger/dist/transports/index.js"(exports) {
    "use strict";
...
var require_setImmediate = __commonJS({
  "../../node_modules/async/internal/setImmediate.js"(exports) {
    ...
    exports.wrap = wrap2;
    var hasQueueMicrotask2 = exports.hasQueueMicrotask = typeof queueMicrotask === "function" && queueMicrotask;
    var hasSetImmediate2 = exports.hasSetImmediate = typeof setImmediate === "function" && setImmediate;
    var hasNextTick2 = exports.hasNextTick = typeof process === "object" && typeof process.nextTick === "function";
    ...
    var _defer2;
    if (hasQueueMicrotask2) {
      _defer2 = queueMicrotask;
    } else if (hasSetImmediate2) {
      _defer2 = setImmediate;
    } else if (hasNextTick2) {
      _defer2 = process.nextTick;
    } else {
      _defer2 = fallback2;
    }
    exports.default = wrap2(_defer2);
  }
});
  ...
  "../../node_modules/async/asyncify.js"(exports, module2) {
    ...
    function asyncify2(func) {
      ...
      return (0, _initialParams2.default)(function(args, callback) {
        ...
        if (result && typeof result.then === "function") {
          return handlePromise2(result, callback);
        } else {
          callback(null, result);
        }
      });
    ...
    function handlePromise2(promise, callback) {
      return promise.then((value) => {
        invokeCallback2(callback, null, value);
      }, (err) => {
        invokeCallback2(callback, err && err.message ? err : new Error(err));
      });
    }
    function invokeCallback2(callback, error2, value) {
      try {
        callback(error2, value);
      } catch (err) {
...
var require_wrapAsync = __commonJS({
  "../../node_modules/async/internal/wrapAsync.js"(exports) {
    ...
    exports.isAsyncGenerator = isAsyncGenerator2;
...
var require_awaitify = __commonJS({
  "../../node_modules/async/internal/awaitify.js"(exports, module2) {
    ...
    function awaitify2(asyncFn, arity = asyncFn.length) {
      if (!arity)
        throw new Error("arity is undefined");
      function awaitable(...args) {
        if (typeof args[arity - 1] === "function") {
...
var require_iterator = __commonJS({
  "../../node_modules/async/internal/iterator.js"(exports, module2) {
    ...
    exports.default = createIterator2;
    var _isArrayLike = require_isArrayLike2();
    var _isArrayLike2 = _interopRequireDefault(_isArrayLike);
    ...
    function createArrayIterator2(coll) {
      var i = -1;
      var len = coll.length;
      return function next() {
        return ++i < len ? { value: coll[i], key: i } : null;
    ...
    function createES2015Iterator2(iterator) {
      var i = -1;
      return function next() {
        var item = iterator.next();
        if (item.done)
    ...
    function createObjectIterator2(obj) {
      var okeys = obj ? Object.keys(obj) : [];
      var i = -1;
      var len = okeys.length;
      return function next() {
    ...
    function createIterator2(coll) {
      if ((0, _isArrayLike2.default)(coll)) {
        return createArrayIterator2(coll);
      }
      var iterator = (0, _getIterator2.default)(coll);
      return iterator ? createES2015Iterator2(iterator) : createObjectIterator2(coll);
    }
    module2.exports = exports["default"];
  }
});
...
var require_eachOf = __commonJS({
  "../../node_modules/async/eachOf.js"(exports, module2) {
    ...
    function eachOfArrayLike2(coll, iteratee, callback) {
      callback = (0, _once2.default)(callback);
      var index2 = 0, completed = 0, { length } = coll, canceled = false;
      if (length === 0) {
        callback(null);
    ...
    function eachOfGeneric2(coll, iteratee, callback) {
      return (0, _eachOfLimit2.default)(coll, Infinity, iteratee, callback);
    }
    function eachOf2(coll, iteratee, callback) {
      var eachOfImplementation = (0, _isArrayLike2.default)(coll) ? eachOfArrayLike2 : eachOfGeneric2;
...
var require_withoutIndex = __commonJS({
  "../../node_modules/async/internal/withoutIndex.js"(exports, module2) {
    ...
    exports.default = _withoutIndex2;
    function _withoutIndex2(iteratee) {
      return (value, index2, callback) => iteratee(value, callback);
    }
    module2.exports = exports["default"];
  }
...
var require_forEach = __commonJS({
  "../../node_modules/async/forEach.js"(exports, module2) {
    ...
    var _withoutIndex2 = require_withoutIndex();
    var _withoutIndex22 = _interopRequireDefault(_withoutIndex2);
    var _wrapAsync = require_wrapAsync();
    var _wrapAsync2 = _interopRequireDefault(_wrapAsync);
    var _awaitify = require_awaitify();
    var _awaitify2 = _interopRequireDefault(_awaitify);
    ...
    function eachLimit2(coll, iteratee, callback) {
      return (0, _eachOf2.default)(coll, (0, _withoutIndex22.default)((0, _wrapAsync2.default)(iteratee)), callback);
    }
    exports.default = (0, _awaitify2.default)(eachLimit2, 3);
    module2.exports = exports["default"];
  }
});
  ...
  "../../node_modules/winston/lib/winston/exception-handler.js"(exports, module2) {
    ...
    module2.exports = class ExceptionHandler {
      ...
      _uncaughtException(err) {
        ...
        if (doExit) {
          timeout2 = setTimeout(gracefulExit, 3e3);
        }
      }
      /**
...
var require_null_transport = __commonJS({
  "../../node_modules/@sap-ux/logger/dist/winston-logger/null-transport.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_vscode_output_channel_transport = __commonJS({
  "../../node_modules/@sap-ux/logger/dist/winston-logger/vscode-output-channel-transport.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_util = __commonJS({
  "../../node_modules/@sap-ux/logger/node_modules/chalk/source/util.js"(exports, module2) {
    "use strict";
...
var require_templates = __commonJS({
  "../../node_modules/@sap-ux/logger/node_modules/chalk/source/templates.js"(exports, module2) {
    "use strict";
...
var require_source = __commonJS({
  "../../node_modules/@sap-ux/logger/node_modules/chalk/source/index.js"(exports, module2) {
    "use strict";
...
var require_adapter = __commonJS({
  "../../node_modules/@sap-ux/logger/dist/winston-logger/adapter.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
${level} ${chalk_1.default.magenta(label)} `);
    ...
    var consoleFormat = winston_1.format.combine(winston_1.format.timestamp({ format: "YYYY-MM-DD HH:mm:ss" }), winston_1.format.printf((_a) => {
      var { timestamp, level, message, label, labelColor } = _a, meta = __rest(_a, ["timestamp", "level", "message", "label", "labelColor"]);
...
var require_utils2 = __commonJS({
  "../../node_modules/@sap-ux/logger/dist/winston-logger/utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_logger2 = __commonJS({
  "../../node_modules/@sap-ux/logger/dist/winston-logger/logger.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
var require_winston_logger = __commonJS({
  "../../node_modules/@sap-ux/logger/dist/winston-logger/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.WinstonLogger = void 0;
    var logger_1 = require_logger2();
    Object.defineProperty(exports, "WinstonLogger", { enumerable: true, get: function() {
