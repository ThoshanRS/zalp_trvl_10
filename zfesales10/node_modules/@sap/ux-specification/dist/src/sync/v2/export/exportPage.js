...
function exportListReportPage(exportParameters, ui5Version) {
    ...
    const pageLayoutInformation = (0, common_1.getPageLayoutInformation)(listReport);
    ...
    if (listReportConfig && Object.keys(listReportConfig).length !== 0) {
        ...
        (0, export_1.transferManifestEntriesAndFlexChange)(transferParameters, listReport, [], [], exportParameters.jsonSchema //starting point for target definition
        );
    }
...
function exportAnalyticalListPage(exportParameters, ui5Version) {
    ...
    //Instantiate base ID
    const pageLayoutInformation = (0, common_1.getPageLayoutInformation)(analyticalListPage);
    const baseId = `${exportParameters.appId}::${pageLayoutInformation.id}::${entitySet}--`;
    const pageKeys = [];
    ...
    if (analyticalListPageConfig && Object.keys(analyticalListPageConfig).length !== 0) {
        ...
        (0, export_1.transferManifestEntriesAndFlexChange)(transferParameters, analyticalListPage, [], [], exportParameters.jsonSchema //starting point for target definition
        );
    }
    return exportResults;
}
...
function exportObjectPage(exportParameters, ui5Version) {
    ...
    if (objectPageConfig) {
        ...
        if (Object.keys(objectPageConfig).length !== 0) {
            ...
            (0, export_1.transferManifestEntriesAndFlexChange)(transferParameters, objectPage, [], [], exportParameters.jsonSchema //starting point for target definition
            );
        }
    }
    return exportResults;
    ...
    if (!validate(overviewPage)) {
        for (const err of validate.errors) {
            ...
            if (err.keyword === 'additionalProperties' &&
                ...
                (0, lodash_unset_1.default)(overviewPage, `${err.dataPath.slice(1)}.${additionalProperty}`);
            }
        }
    }
    if (exportParameters.page.config && Object.keys(exportParameters.page.config).length !== 0) {
        (0, export_1.transferManifestEntriesOVP)(overviewPage, exportResults, exportParameters.jsonSchema, exportParameters.jsonSchema, factory, []);
    }
    return exportResults;
};
/**
