...
import type { Manifest, ExtensionLogger, FacetConfig, FacetConfigs, FacetSection, FileData, SchemaFilePath } from '@sap/ux-specification-types';
 ...
 */
export declare const getSchemaFilePath: (schemaType: SchemaType | PageTypeV2 | PageTypeV4, entitySet?: string) => SchemaFilePath;
/**
