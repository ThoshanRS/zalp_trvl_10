...
function convertSettingsToConfig(params) {
    const schemaId = (0, common_1.generatePageId)(params.page.pageType, params.page.entitySet, params.target['viewId'] || (params.pageType === ux_specification_types_1.PageTypeV4.CustomPage && params.target['id']));
    if (!schemaId) {
        return;
    }
