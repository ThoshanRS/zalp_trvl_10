...
exports.Table = exports.MultiTableModeV4 = exports.TableViewExtension = exports.LRTableView = exports.LRChartView = exports.ALPTable = exports.TableViewSettings = exports.CommonViewSettings = exports.ALPChart = exports.TableSettings = exports.QuickVariantSelectionV4 = exports.deleteCreationModeCreateAtEnd = exports.exportCreationModeCreateAtEnd = exports.deleteCreationModeName = exports.exportPersonalizationProperty = exports.exportPersonalization = exports.checkViewOrder = exports.exportCreationModeName = void 0;
...
__decorate([
    (0, decorators_1.syncRule)({
        manifest: {
            path: (entitySet) => (0, application_1.getSettingsPathForPage)(entitySet) + '/views/paths/0/primary/0',
            delete: deleteView
        }
    })
...
__decorate([
    (0, decorators_1.syncRule)({
        manifest: {
            path: (entitySet) => (0, application_1.getSettingsPathForPage)(entitySet) + '/views/paths/0/secondary/0',
            delete: doNotDelete
        }
    })
...
__decorate([
    (0, decorators_1.syncRule)({
        manifest: {
            path: (entitySet) => (0, application_1.getSettingsPathForPage)(entitySet) + '/views'
        }
    })
