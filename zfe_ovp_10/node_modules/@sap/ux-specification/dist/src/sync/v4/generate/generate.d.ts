 ...
 */
export declare function generateObjectPageInterfaceV4(genericSchema: object, entitySetName: string, annotations: FileData[], manifest: Manifest, logger?: ExtensionLogger, fragments?: FileData[]): object;
/**
 ...
 * @returns the app specific JSON schema
 */
export declare function generateListReportInterfaceV4(templateType: TemplateType, genericSchema: object, entitySetName: string, annotations: FileData[], logger?: ExtensionLogger, manifest?: Manifest): object;
/**
 ...
 * @returns the app specific JSON schema
 */
export declare function generateFreestyleInterfaceV4(templateType: TemplateType, genericSchema: object, annotations: FileData[], manifest?: Manifest, entitySetName?: string, logger?: ExtensionLogger): object;
