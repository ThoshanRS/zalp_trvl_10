...
exports.ObjectPageTable = exports.QuickVariantSelectionV4OP = exports.TableCreationModeOP = void 0;
    ...
    (0, decorators_1.syncRule)({
        manifest: {
            ...
            export: (manifestSection, configObject, key, manifestKey) => {
                (0, Table_1.exportCreationModeName)(manifestSection, configObject, key, manifestKey);
            },
            delete: (manifestSection, _configObject, _key, manifestKey) => {
                (0, Table_1.deleteCreationModeName)(manifestSection, manifestKey);
            }
        }
    })
...
__decorate([
    (0, decorators_1.syncRule)({
        manifest: {
            path: (pageName, manifest, sectionId) => (0, application_1.getTableSettingsPathForOP)(pageName, manifest, sectionId),
            export: (manifestSection, configObject, key, manifestKey) => {
                (0, Table_1.exportCreationModeCreateAtEnd)(manifestSection, configObject, key, manifestKey);
            },
            delete: (manifestSection, _configObject, _key, manifestKey) => {
                (0, Table_1.deleteCreationModeCreateAtEnd)(manifestSection, manifestKey);
            }
        }
    })
