...
function getManifestId(sectionId, splitOnLt = false) {
    ...
    const pathParts = tableId.split(`@${"com.sap.vocabularies.UI.v1.LineItem" /* UIAnnotationTerms.LineItem */}`);
    return `${pathParts[0]?.replace(/::/g, '/')}@${"com.sap.vocabularies.UI.v1.LineItem" /* UIAnnotationTerms.LineItem */}${pathParts[1]?.replace(/::/g, '#')}`;
}
