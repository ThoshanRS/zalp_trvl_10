		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibmzpurchase10btpsap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibmzpurchase10btpsap-display": {
								"semanticObject": "comibmzpurchase10btpsap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibm.zpurchase10.btpsap",
									"url": sap.ui.require.toUrl("com/ibm/zpurchase10/btpsap")
								}
							}
						}
					}
